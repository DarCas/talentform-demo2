...
$count = count($items);
?>
<form action="/backend/backup/delete" method="post">
    @csrf
            ...
            <tr>
                ...
                <td style="width: 20px" class="text-center">
                    <a class="btn btn-sm btn-info"
                       href="/backend/backup/dwl/{{ $row['filename'] }}"
                    >
                        ...
                        <ul class="dropdown-menu dropdown-menu-end bg-danger shadow">
                            <li>
                                <a class="dropdown-item bg-danger text-white"
                                   href="/backend/backup/delete/{{ $row['filename'] }}">
                                    Conferma cancellazione
                                </a>
                            </li>
                        </ul>
            ...
            <tr>
                <td colspan="7" class="py-5">
                    @include('partials.alert', [
                        'message' => 'Non ci sono files di backup',
                        'type' => 'info',
                        'size' => '50%',
                    ])
                </td>
