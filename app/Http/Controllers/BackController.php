...
//                ->first();
    ...
    function recuperaPassword(): mixed
    {
        if ($this->imLogged()) {
            ...
            return $this->renderContent(
                content: view('backend.partials.recupera-password')->render(),
                alertTemplate: $alertTemplate ?? null,
                refresh: isset($alertTemplate) ? "5; url=/backend/" : null,
            );
        }
    ...
    private function renderDatagrid(Request $request): string
    {
        ...
        return view('backend.partials.datagrid', [
     ...
     * @return User|false
     */
    private function imLogged(): User|false
    {
